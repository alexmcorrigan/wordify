...
public class NumberGroupTranslatorTest {
	...
	private NumberGroupTranslator numberGroupTranslation = new NumberGroupTranslator();
	...
	private void assertTranslationFor(int number, String expectedTranslation, String expectedAppendage) {
		NumberGroup numberGroup = numberGroupTranslation.translate(number, 1, 0);
		assertEquals(expectedTranslation, numberGroup.getNumberGroupTranslation());
		assertEquals(expectedAppendage, numberGroup.getNumberGroupAppendage());
	}
